...
<body>
	...
	<form action="" method="POST">
		...
		<input type="text" id="nationality" name="nationality" require>
		...
		<textarea id="hotel" name="hotel" rows="4" require></textarea>

		<label for="pickup">Pick-up Time:</label>
		<input type="time" id="pickup" name="pickup" require>
		...
		<input type="number" id="group" name="group" require>

		<label for="tour">Name of Tour/Activity:</label>
                <select id="tour" name="tour" require>
		...
		<textarea id="info" name="info" rows="4" require></textarea>
